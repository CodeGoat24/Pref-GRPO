...
def embedding_dataloader_wrapper(dataloader, device):
    while True:
        for prompt_embeds, text_ids, instructions, source_images, target_images in dataloader:
            prompt_embeds = prompt_embeds.to(device)
            text_ids = text_ids.to(device)
            yield prompt_embeds, text_ids, instructions, source_images, target_images
...
def train_one_step(
    ...
    optimizer.zero_grad()
    prompt_embeds, text_ids, instruction, source_images, target_images = next(loader)
