...
export EXP_NAME="unifiedreward_flex_point_flux2_klein_edit_9b"

export VLLM_MAX_WORKERS=32
export VLLM_LOG_STATS=0


export EDIT_QUALITY_WEIGHT_NATURALNESS=0.6
export EDIT_QUALITY_WEIGHT_ARTIFACTS=0.4

export EDIT_IF_WEIGHT_SUCCESS=0.6
export EDIT_IF_WEIGHT_OVEREDIT=0.4
...
TRAIN_ARGS=(
  ...
  --data_json_path data/flux2_klein_edit_embeddings/edit_data.json
  --exp_name "${EXP_NAME}"
  --num_sample 100000
  --train_batch_size 1
